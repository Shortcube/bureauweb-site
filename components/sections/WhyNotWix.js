...
const WhyNotWix = () => {
  ...
  const wixLimits = [
    ...
    'Assistance en anglais via chatbot',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-navy mb-6">
              Plateformes en libre-service : pourquoi payer plus ?
            </h2>
            <p className="text-xl text-concrete-600 leading-relaxed">
              Une solution en libre-service peut commencer autour de ~20$/mois (prix indicatif selon options). BureauWeb, c’est 199$/mois. Voici ce qui justifie la différence: on opère et maintient l’infrastructure pour vous (hébergement, mises à jour, correctifs, structure Google, suivi).
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            ...
            <div className="bg-concrete-50 rounded-xl p-6 border border-concrete-200">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <h3 className="font-semibold text-navy">Libre-service</h3>
              ...
              <ul className="space-y-3">
                {wixLimits.map((limit, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    {/* was: text-red-500 */}
                    <X className="w-5 h-5 text-concrete-500 flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-navy/5 rounded-xl p-6 text-center">
            <p className="text-concrete-700 leading-relaxed mb-6">
              <strong>En résumé :</strong> Libre-service si vous aimez bricoler et avez du temps.
